...
import image from "../../../public/lajitha2.png";
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 md:pt-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1 space-y-6 md:space-y-8">
            ...
            I am a UI/UX designer with a background in Computer Science and Business Systems. 
            My journey into design has highlighted the power of user-centered visuals in shaping
            experiences and behaviors. I specialize in crafting engaging, accessible interfaces 
            that truly resonate with users. Passionate about blending creativity with functionality,
            I strive to design meaningful solutions that make a real impact. Let’s collaborate to
            ...
            <div className="flex space-x-4 items-center">
              ...
              <a
                href="https://www.instagram.com/lajitha_alagarbabu/"
              ...
              <a
                href="https://www.linkedin.com/in/lajitha-alagarbabu-0aa843264/"
